...
var d=window.document;d.write(". ");var e=d.head.appendChild(d.createElement("title"));e.innerHTML="Keep Them Small &ndash; "+kts_version;b=d.body;b.innerHTML="";var a=b.appendChild(d.createElement("canvas"));a.style.position="fixed";a.style.left="0";a.style.top="0";d.addEventListener("resize",resize);
...
o.fillText("KTS "+kts_version,w/2,h*0.12);
