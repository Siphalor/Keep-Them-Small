function kts(){
var d=window.document;d.write(". ");var e=d.head.appendChild(d.createElement("title"));e.innerHTML="Keep Them Small";b=d.body;b.innerHTML="";var a=b.appendChild(d.createElement("canvas"));a.style.position="fixed";a.style.left="0";a.style.top="0";d.addEventListener("resize",resize);
